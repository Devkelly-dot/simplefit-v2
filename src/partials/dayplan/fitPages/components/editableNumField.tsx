...
const EditableNumField: React.FC<Props> = ({object, editField, goalField, type}) => {
    ...
    async function editNumber(new_value)
    {
        ...
        createFitObject(dispatch, selectedDayplan.id, token, 'lift', new_object)
    }
    ...
    return (
        <div className="flex gap-2 items-center">
            ...
            <input value = {object[editField]} className='w-10 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' onChange={handleNumChange} onBlur={editOnBlur}/> / {object[goalField]}
